...
function EmailRead() {
    const email = {
        ...
        cc: "manager@example.com", // Set to null or "" to hide the section
        bcc: "mueez@gmail.com",    // Set to null or "" to hide the section
        subject: "Meeting Reminder",
        body: `<p>Hi Jane,</p>
               <p>Please remember our meeting scheduled for today at 3 PM in Conference Room A.</p>
               <p>Regards,<br>John</p>`,
        time: "Nov 21, 2024, 9:00 AM",
        attachments: [
            { name: "Agenda.pdf", url: "/path/to/agenda.pdf" },
            { name: "Minutes.docx", url: "/path/to/minutes.docx" },
        ],
        profilePic: "https://www.w3schools.com/w3images/avatar2.png" // Add a profile picture URL here
    };
        ...
        <div className="min-h-screen bg-white flex justify-center items-center py-8 px-4 mt-8">
            <div className="bg-white shadow-2xl rounded-lg w-full max-w-5xl">
                ...
                <div className="p-6 space-y-4 border-b bg-gray-50">
                    ...
                    {/* Conditionally render CC if it exists */}
                    ...
                    {/* Conditionally render BCC if it exists */}
